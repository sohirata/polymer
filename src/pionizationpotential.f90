...
! K.HIRAO & H.NAKATSUJI,J.COMPUT.PHYS.45,246(1982).
   ...
   WRITE(6,'(/,A)') '***************************'
   WRITE(6,'(A)')   '* GENERAL-ORDER IP-EOM-CC *'
   WRITE(6,'(A)')   '***************************'
...
! ===================================================================
   ...
   ! Kluwer Academic Publishers: Boston, MA, 2001; pp 131−160. Eq.4.2
   write(*,'(A)') "*************************************************************************************"
   ...
   write(*,'(A)') "* Kluwer Academic Publishers: Boston, MA, 2001; pp 131−160. Eq.(4.2).               *"
   write(*,'(A)') "*************************************************************************************"
