...
! HIGH-ORDER EOM-CC
! ---------------------------------------------------------------
   IF ((IOPTN(59) > 0).AND.(IOPTN(53) > 0)) THEN
    IF ((.NOT.LOPTN(60)).AND.(.NOT.LOPTN(61))) THEN
     ! EOMEE-CC
...
! IF LLEFT=.TRUE., LEFT-HAND EIGENVECTORS WILL BE SOUGHT INSTEAD OF RIGHT-HAND EIGENVECTORS.
   ...
   WRITE(6,'(/,A)') '************************'
   WRITE(6,'(A)')   '* GENERAL-ORDER EOM-CC *'
   WRITE(6,'(A)')   '************************'
