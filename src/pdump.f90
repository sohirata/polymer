...
! DUMP THE ELEMENTS OF A REAL MATRIX OF THE FORM W(N,N)
   ...
   I=INT(FLOAT(N)/10.0)
   DO K=1,I
    WRITE(6,'(3X,10I15)') (L,L=10*K-9,10*K)
    DO L=1,N
     WRITE(6,'(I5,10F15.11)') L,(W(L,M),M=10*K-9,10*K)
!    WRITE(6,'(I5,10E10.3)') L,(W(L,M),M=10*K-9,10*K)
    ENDDO
   ENDDO
   IF (N /= I*10) THEN
    WRITE(6,'(3X,10I15)') (L,L=10*I+1,N)
    DO L=1,N
     WRITE(6,'(I5,10F15.11:)') L,(W(L,M),M=10*I+1,N)
!    WRITE(6,'(I5,10E10.3:)') L,(W(L,M),M=10*I+1,N)
    ENDDO
   ENDIF
