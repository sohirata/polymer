...
!      IF ((E0(J)-PREVIOUSMIN > 1.0D-9).AND.(E0(J) < CURRENTMIN)) THEN
     ...
     IF (LFULL) THEN
      ...
      WRITE(6,'(/,A,I4,A,I4,A)') 'FULL DIAGONALIZATION OF ',NCFA*NCFB,' X ',NCFA*NCFB,' MATRIX'
     ...
     ELSE
      ...
      DO I=1,NTARGETS
       DO J=1,MDEGEN(I)
        ...
        WRITE(6,'(A,A)') 'EXACT WAVE FUNCTIONS WRITTEN TO ',TRIM(COPTN(1))//'.exact.'//FULLAPPEND
       ENDDO
       WRITE(6,'(/,A,I3)') 'TARGET',I
       WRITE(6,'(A,I4,A,I4,A,I3,A)') 'SUBSPACE DIAGONALIZATION OF ',NCFA*NCFB,' X ',NCFA*NCFB,' MATRIX FOR ',MDEGEN(I),' ROOTS'
...
!    -----------------
     ...
     DO ISTATE=1,NTARGETS
      ...
      DO I=1,NDEGEN
       ...
       WRITE(6,'(A,A)') 'EXACT WAVE FUNCTION READ FROM ',TRIM(COPTN(1))//'.exact.'//FULLAPPEND
      ENDDO
      OPEN(90,FILE=TRIM(COPTN(1))//'.tmp1',FORM='UNFORMATTED')
!     -----------------------------------------------------------------
...
! CALCULATE FULL CI MATRIX
   ...
   WRITE(6,'(A,100I5:)') 'REFERENCES = ',(LIST(I),I=1,NDEGEN)
