...
!   WRITE(6,'(A,I2,A,F20.10)') '                  EPSILON(',ITOMONAGA,') = ',DTOMONAGA
!   WRITE(6,'(A)') '*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!'
   ENDIF
   ...
   ELSE IF (STATE==1) THEN
    DO IB=1,IP_NCF
     HB=0.0D0
     DO I=1,IOCC
      IF (BTEST(IP_CFHALF(IB),I-1)) HB=HB+TEPS(I)
     ENDDO
     DO I=IOCC+1,IALL(0,0,0)-IVIRTCORE
      IF (BTEST(IP_CFHALF(IB),I-1)) HB=HB+TEPS(I)
     ENDDO
   ...
   ELSE IF (STATE==-1) THEN
    DO IB=1,EA_NCF
     HB=0.0D0
     DO I=1,IOCC
      IF (BTEST(EA_CFHALF(IB),I-1)) HB=HB+TEPS(I)
     ENDDO
     DO I=IOCC+1,IALL(0,0,0)-IVIRTCORE
      IF (BTEST(EA_CFHALF(IB),I-1)) HB=HB+TEPS(I)
     ENDDO
