...
SUBROUTINE HIGHORDER_GF_REDUX1(OMEGA,ORDER,DIAG,EIGN,GREN,NORB)
! PERFORM HIGH-ORDER MBGF CALCULATIONS WITHOUT IP/EA PERTURBATION EXPANSION
   ...
   DOUBLE PRECISION :: DIAG(NORB,0:ORDER-1),EIGN(NORB,0:ORDER-1),GREN(NORB,0:ORDER-1)
